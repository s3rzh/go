...
// Го алоцирует массив в стеке ЕСЛИ его размер меньше и равен (<=) 10 Мб, если больше - будет на хипе, так же на хипе будет если на массив кто-то ссылается за пределами функции (за это отвечает escape analysis).
