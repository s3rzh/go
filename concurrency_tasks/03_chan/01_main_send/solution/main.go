...
// а иногда и горутина будет не успевать напечатать данные (хоть и вычитывает их из канала, тк строка mt.Println("Hello " + <-c + "!") не атомарна, тут несколько действие, как мин. чтение из канал, затем канкатенация, затем печать и др)
main() started
main() stopped
