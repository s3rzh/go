...
// Ещё ВАЖНЫЙ момент читатеть те go greet(c), в данном случае с main должен должен быть до писателя main (как в примере) иначе будет fatal error: all goroutines are asleep - deadlock!
