...
// Ещё ВАЖНЫЙ момент читатеть те go greet(c), в данном случае должен быть обьявлен до писателя те main (как в примере) иначе будет fatal error: all goroutines are asleep - deadlock! Если же читатель и писатель это другие горутины (не main) то порядок неважен!
