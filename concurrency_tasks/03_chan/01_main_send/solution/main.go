...
// Ещё ВАЖНЫЙ момент читатеть те go greet(c), в данном случае должен быть до писателя те main (как в примере) иначе будет fatal error: all goroutines are asleep - deadlock!
